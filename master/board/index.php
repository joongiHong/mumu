...
<html lang="ko">
  ...
  <body>
    ...
    <div id="main_content">
      ...
      <p>게시판에 새로운 글을 작성할 수 있습니다.</p>
      <a href="write.php?new=1"><button class="i_button_1" style="margin: 0;">글 작성</button></a>
      <br/>
      <br/>
      <h1 class="title">작성글 목록</h1>
      <p>관리자 페이지에서 작성한 글 목록 열람 및 삭제, 수정을 하실 수 있습니다.</p>
      <br/>
      <table class="table table-hover">
        ...
        <tbody>
          ...
          while($row = mysqli_fetch_array($result)) {
            ...
            echo '<th>'.$row['date'].'</th>';
            echo '<th><a href="write.php?new=0&num='.$row['num'].'"><button class="i_button_2">수정</button></a> <a href="delete.php?num='.$row['num'].'"><button class="i_button_3">삭제</button></a>';
            echo '</tr>';
          }
          ?>
        </tbody>
