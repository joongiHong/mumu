    ...
    <div id="main_content">
      ...
      <form action="setting.php" method="POST" />
        ...
        <div class="custom-control custom-switch">
          <input type="checkbox" name="db_utf8_yn" class="custom-control-input" id="db_utf8_yn" aria-describedby="db_utf8_yn_helper" <?php if ($su8 == 1) { echo "checked"; } ?>>
        ...
        <div class="custom-control custom-switch">
          <input type="checkbox" name="security_google_yn" class="custom-control-input" id="security_google_yn" <?php if ($recaptcha == 1) { echo "checked"; } ?>>
        ...
        <input type="text" class="i_text_1" name="security_google_secretkey" placeholder="리캡차 api 시크릿키" <?php if ($recaptcha == 1) { echo "value='".$g_secretkey."'"; } ?>/>
        <br/>
        <label for="security_google_sitetkey">API 사이트키</label>
        <input type="text" class="i_text_1" name="security_google_sitekey" placeholder="리캡차 api 사이트키" aria-describedby="security_google_sitekey_helper" <?php if ($recaptcha == 1) { echo "value='".$g_sitekey."'"; } ?>/>
        ...
        <div class="custom-control custom-switch">
          <input type="checkbox" name="security_checkstudent_yn" class="custom-control-input" id="security_checkstudent_yn" <?php if ($checkstudent == 1) { echo "checked"; } ?>>
        ...
        <div class="custom-control custom-switch">
          <input type="checkbox" name="manage_serviceoff_yn" class="custom-control-input" id="manage_serviceoff_yn" <?php if ($serviceoff == 1) { echo "checked"; } ?>>
          <label class="custom-control-label" for="manage_serviceoff_yn">서비스 일시 중단</label>
        </div>
        <label for="manage_serviceoff_reason">중단 사유</label>
        <input type="text" class="i_text_1" name="manage_serviceoff_reason" placeholder="중단 사유" aria-describedby="smanage_serviceoff_reason_helper" <?php if ($serviceoff == 1) { echo "value='".$serviceoff_r."'"; } ?>/>
