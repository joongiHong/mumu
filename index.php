...
<html lang="ko">
  <head>
    ...
    <link rel="stylesheet" href="css/index.css?new" />
  ...
  <body>
    ...
    <div id="banner">
      <a href="#"
        ><img src="image/banner.jpg" alt="듣고 싶은 음악이 있다면... mumu"
      /></a>
    </div>
    ...
    <div id="footer">
        <a href="opensource.php"><p>본 서비스에는 오픈소스가 사용되었습니다.<br/>제작자분들께 감사드립니다.</p></a>
